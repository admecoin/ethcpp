...
BOOST_AUTO_TEST_CASE(condensingtransactionbehavior_tests){
    ...
    for(size_t i = 0; i < 3; i++){
        txs.push_back(createBCSTransaction(code[i], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), i));
        addresses.push_back(createBCSAddress(hashTemp, i));
        ++hashTemp;
    }
    ...
    txs.clear();
    for(size_t i = 0; i < 3; i++){
        txs.push_back(createBCSTransaction(code[i + 3], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[i]));
    }
    ...
    txs.clear();
    txs.push_back(createBCSTransaction(code[6], 8000, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    result = executeBC(txs);
    ...
    txs.clear();
    txs.push_back(createBCSTransaction(code[7], 2000, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    txs.push_back(createBCSTransaction(code[8], 2000, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    result = executeBC(txs);
    ...
    txs.clear();
    txs.push_back(createBCSTransaction(code[6], 2000, dev::u256(30000), dev::u256(1), hashTemp, addresses[1]));
    txs.push_back(createBCSTransaction(code[9], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[1]));
    result = executeBC(txs);
    balances = {0,0,0};
    checkRes(result.second, addresses, balances, 2);
...
BOOST_AUTO_TEST_CASE(condensingtransactionbreadthways_tests){
    ...
    txs.push_back(createBCSTransaction(code[10], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), 4));
    addresses.push_back(createBCSAddress(hashTemp, 4));
    auto result = executeBC(txs);

    txs.clear();
    txs.push_back(createBCSTransaction(code[0], 15000, dev::u256(500000), dev::u256(1), hashTemp, addresses[3]));
    txs.push_back(createBCSTransaction(code[11], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[3]));
...
BOOST_AUTO_TEST_CASE(condensingtransactiondeep_tests){
    ...
    auto result = executeBC(txs);
    txs.clear();
    txs.push_back(createBCSTransaction(code[11], 20000, dev::u256(500000), dev::u256(1), hashTemp, addresses[4]));
    result = executeBC(txs);
...
BOOST_AUTO_TEST_CASE(condensingtransactionsuicide_tests){
    ...
    std::vector<dev::Address> addresses;
    std::vector<BCSTransaction> txs;
    txs.push_back(createBCSTransaction(code[12], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), 0));
    addresses.push_back(createBCSAddress(hashTemp, 0));
    
    txs.push_back(createBCSTransaction(code[17], 0, dev::u256(500000), dev::u256(1), ++hashTemp, dev::Address(), 1));
    txs.push_back(createBCSTransaction(valtype(), 13000, dev::u256(500000), dev::u256(1), hashTemp, createBCSAddress(hashTemp, 1), 1));

    addresses.push_back(createBCSAddress(hashTemp, 1));
    auto result = executeBC(txs);

    txs.clear();
    txs.push_back(createBCSTransaction(code[18], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[1]));
    result = executeBC(txs);
...
BOOST_AUTO_TEST_CASE(condensingtransactionpaytopubkeyhash_tests){
    ...
    txs.push_back(createBCSTransaction(code[19], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), 13));
    txs.push_back(createBCSTransaction(valtype(), 13000, dev::u256(500000), dev::u256(1), hashTemp, createBCSAddress(hashTemp, 13), 13));

    addresses.push_back(createBCSAddress(hashTemp, 13));
    auto result = executeBC(txs);

    txs.clear();
    txs.push_back(createBCSTransaction(code[11], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    result = executeBC(txs);
