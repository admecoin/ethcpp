...
#include "genesis/bcsMainNetwork.cpp"
...
#include "genesis/test/bcsTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::bcsMainNetwork: return c_genesisInfoBCSMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::bcsTestNetwork: return c_genesisInfoBCSTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::bcsMainNetwork: return c_genesisStateRootBCSMainNetwork;
    case Network::bcsTestNetwork: return c_genesisStateRootBCSTestNetwork;
