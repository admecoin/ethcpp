...
////////////////////////////////////////////////////////////// // bcs
	void setBCSSchedule(EVMSchedule _bcsSchedule) const { bcsSchedule = _bcsSchedule; }

	EVMSchedule& getBCSSchedule() const { return bcsSchedule; }
...
private:
	...
	mutable EVMSchedule bcsSchedule; // bcs
