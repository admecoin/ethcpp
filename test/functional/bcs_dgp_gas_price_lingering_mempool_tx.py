...
"""
class BCSDGPGasPriceLingeringMempoolTxTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_node(1)
        self.start_node(1)
        self.nodes[1].createcontract("00", 1000000, BCS_MIN_GAS_PRICE_STR)
...
if __name__ == '__main__':
    BCSDGPGasPriceLingeringMempoolTxTest().main()
