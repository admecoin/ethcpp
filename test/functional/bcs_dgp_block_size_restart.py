...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see bcs-dgp.py
"""
class BCSDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the bcsd to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    BCSDGPActivation().main()
