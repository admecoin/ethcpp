...
### Setting up Gitian
1. Replace .yml files in bcs/contrib/gitian-descriptors folder. Replace gitian-build.sh in bcs/contrib folder. Add windeploy/ folder into the bcs/contrib. Push these changes to remote repository https://github.com/cryptofugu/bcschain-core/. Also very important, windeploy/ folder should be The same version as you want to build. You will couldn't build win binaries without this folder in version which you want to build.
...
2. Create the OS X SDK tarball( https://github.com/cryptofugu/bcschain-core/blob/master/doc/README_osx.md), create inputs/ folder in gitian-builder/ . Copy MacOSX10.11.sdk.tar.gz into the inputs/ directory.
##### Not first time
